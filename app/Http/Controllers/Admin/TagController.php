...
class TagController extends Controller
{
    ...
    {
        $tags=Tag::all();
        return view('admin_panel.tag.index', ['tags'=>$tags]);
    }
    ...
    {
        return view('admin_panel.tag.create');
    }
    ...
    {
        return view('admin_panel.tag.details',['tag'=>$tag]);
    }
    ...
    {
        return view('admin_panel.tag.edit',['tag'=>$tag]);
    }
